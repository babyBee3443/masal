...
export default function SchedulingPage() {
  ...
  const handleAddScheduledGeneration = () => {
    ...
    startTransition(async () => {
      ...
      if (result.success && result.scheduledGeneration) {
        ...
        fetchScheduledItems(); // Refresh list
  ...
  const handleProcessGeneration = (id: string) => {
    startTransition(async () => {
      ...
      fetchScheduledItems(); // Refresh list regardless of outcome
    });
  };
  ...
  if (isLoading && scheduledGenerations.length === 0) {
    return (
  ...
  if (error) {
    return (
      <div className="text-center py-10 text-red-600 bg-red-50 p-6 rounded-lg shadow-md">
        ...
        <p>{error}</p>
        <Button onClick={fetchScheduledItems} variant="destructive" className="mt-4">
  ...
  return (
    <div className="space-y-8">
      ...
      <h2 className="text-2xl md:text-3xl font-semibold text-foreground tracking-tight mb-6">
        ...
        <Button onClick={fetchScheduledItems} variant="ghost" size="icon" className="ml-2" disabled={isTransitioning || isLoading}>
