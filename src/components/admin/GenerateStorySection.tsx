  ...
  const handleGenerateStory = () => {
    ...
    startTransition(async () => {
      ...
      if (result.success && result.story) {
        toast({ title: 'Hikaye Oluşturuldu!', description: `"${result.story.title}" oluşturuldu ve incelenmeyi bekliyor.` });
  ...
  return (
    <Card className="shadow-lg">
      <CardHeader>
        ...
        <CardDescription>Bir tür seçin ve yapay zekanın yeni bir masal örmesine izin verin.</CardDescription>
      </CardHeader>
